...
export function FeaturesSection({ locale }: { locale: Locale }) {
  ...
  const features = [
    { key: "autoCapture", icon: featureIcons.autoCapture },
    { key: "realTime", icon: featureIcons.realTime },
    { key: "private", icon: featureIcons.private },
    { key: "easy", icon: featureIcons.easy },
    { key: "filters", icon: featureIcons.filters },
    { key: "mcp", icon: featureIcons.mcp },
  ]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {locale === "en"
              ...
              : "Todo lo que necesitas para depurar más rápido e inteligentemente"}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature) => {
            const featureData = t.features[feature.key as keyof typeof t.features] as { name: string; desc: string }
            return (
              <div
                key={feature.key}
              ...
              >
                ...
                <p className="text-muted-foreground">{featureData.desc}</p>
              </div>
            )
          })}
        </div>
